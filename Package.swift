...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "Libmpv",
            url: "https://github.com/edde746/mpv-build/releases/download/binaries-apple/Libmpv-d61c7793b293.xcframework.zip",
            checksum: "ea7f48ee8b7ba519b39b70fe680f96cea9e09d2ae89c323906341af1b85af940"
        ),
